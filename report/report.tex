...
Q-Learning methods learn (or approximate) the optimal action-value function.
Q-Learning methods tend to be less stable
But when optimal values are found they tend to be more sample efficient than policy optimization alternatives, because they can reuse old samples more effectively.
