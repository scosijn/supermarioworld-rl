...
\begin{description}[leftmargin=0cm]
    ...
    \item[Environment.]
    World that the agent lives in (here, the game).
    ...
    A frame is an image of the game; a raster of pixels of the form height\texttimes{}width\texttimes{}color.
...
To reduce the memory requirement, each observation is rescaled from 256\texttimes{}224 pixels to 84\texttimes{}84 pixels.
